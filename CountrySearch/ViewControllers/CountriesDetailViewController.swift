...
class CountriesDetailViewController: UIViewController {
    ...
    @IBOutlet private var nativeName: UILabel!
    @IBOutlet private var capital: UILabel!
    @IBOutlet private var region: UILabel!
    @IBOutlet private var languages: UILabel!
    @IBOutlet private var germanTranslation: UILabel!
    @IBOutlet private var flag: UIView!
    @IBOutlet private var area: UILabel!
    ...
    func loadCountryDetails() {
        overlay.showOverlay(view: view)
        store.fetchDetailsOfCountryWith(code: selectedCountryCode) { [weak self] countryData, _ in
    ...
    func populateDataWith(countryDetails: CountryViewModel) {
        ...
        flag.addSubview(flagView)
    }

    func centerMapOnLocation(location: CLLocation) {
        let span = MKCoordinateSpan(latitudeDelta: 15.00, longitudeDelta: 15.00)
